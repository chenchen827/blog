...
const DepthCarousel = ({
  ...
  const activeItem = data[active] || data[0] || null;
  ...
  return (
    ...
    >
      ...
      {showItemInfo && activeItem && (
        <>
          <div className="depth-carousel__meta depth-carousel__meta--title">
            <span className="depth-carousel__meta-label">NAME</span>
            <h2 className="depth-carousel__meta-heading">{activeItem.title || activeItem.alt || 'Untitled'}</h2>
          </div>
          <div className="depth-carousel__meta depth-carousel__meta--description">
            <span className="depth-carousel__meta-label">INTRO</span>
            <p className="depth-carousel__meta-copy">{activeItem.description || 'No description archived.'}</p>
          </div>
        </>
      )}
