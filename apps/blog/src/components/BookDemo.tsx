    ...
    <div className="relative flex h-full w-full flex-col justify-between overflow-hidden bg-gradient-to-b from-[#141414] to-[#0c0c0c] p-5">
      ...
      <div className="relative">
        ...
        <p className="mt-2 text-xs leading-relaxed text-text-secondary">
          A single-page dispatch from the city archive. Hover the stack to flip it open.
        </p>
      </div>
    ...
    <section className="mt-16 border-t border-hairline pt-10">
      <header className="flex items-end justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 text-[28px] font-extrabold uppercase leading-none tracking-[-0.01em] text-text-primary">
            Book · 翻页书架
          </h2>
        </div>
        <span className="hidden pb-1 text-[10px] font-black uppercase tracking-[0.4em] text-text-secondary sm:block">
          Issue 01 – 06
        </span>
      </header>
