...
export default function PostDetail() {
  ...
  if (!article) {
    return (
      <div className="space-y-6">
        <Link to="/posts" className="text-sm text-text-secondary transition-colors hover:text-text-primary">← 返回文章</Link>
  ...
  return (
    <article className="mx-auto max-w-3xl space-y-8">
      <Link to="/posts" className="inline-block text-sm text-text-secondary transition-colors hover:text-text-primary">← 返回文章</Link>
