    ...
    <div className="space-y-16">
      ...
      <section className="relative overflow-hidden rounded-none border border-hairline bg-primary/60 px-6 py-14 md:px-10 md:py-20">
        ...
        <div className="relative max-w-3xl">
          ...
          <h1 className="mt-4 text-4xl font-black uppercase leading-[0.95] tracking-[-0.02em] text-text-primary md:text-6xl">{siteName}</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {!user && (
              <>
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center rounded-none bg-accent px-9 py-4 text-sm font-black uppercase tracking-wide text-ink transition-[filter] hover:brightness-90"
                >
                  登录
                </Link>
                <Link
                  to="/register"
                  className="inline-flex items-center justify-center rounded-none bg-surface-soft px-9 py-4 text-sm font-black uppercase tracking-wide text-text-primary transition-colors hover:bg-surface"
                >
                  注册
                </Link>
              </>
          ...
          {articles.length > 0 && (
            <section className="space-y-6">
              <SectionHeader
                ...
                desc="来自档案的近期文章。"
                action={
                  <Link to="/posts" className="text-sm font-black uppercase tracking-wider text-accent hover:underline">
                    查看全部 →
                  </Link>
                }
              />
