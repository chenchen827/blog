...
export default function CourseDetail() {
  ...
  if (!course) {
    return (
      <div className="space-y-6">
        <Link to="/knowledge" className="text-sm text-text-secondary transition-colors hover:text-text-primary">← 返回知识库</Link>
  ...
  return (
    <div className="space-y-10">
      <Link to="/knowledge" className="inline-block text-sm text-text-secondary transition-colors hover:text-text-primary">← 返回知识库</Link>
                  ...
                  <div className="border-t border-hairline px-5 py-4">
                    {needLogin ? (
                      <p className="text-sm text-text-secondary">
                        章节内容需要登录后查看。<Link to="/login" className="text-accent hover:underline">去登录</Link>
                      </p>
                    ) : chapterBody ? (
