...
/** 登录接入前的临时鉴权 Token，token 与 x-token 暂用同一值 */
const TOKEN =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMsImlhdCI6MTc4ODUxNjI5OCwiZXhwIjoxNzkxMTA4Mjk4fQ.pIUvw2vECuZXSiT1Kz1M7GRnQrE249OuR6FQzRFVdYk'
