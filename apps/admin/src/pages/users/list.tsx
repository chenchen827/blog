...
export default function UserListPage() {
  ...
  const { users, loading, error, field, keyword, pagination, load, search, changeField, onTableChange, clearError } = useAdminUserList({});
  ...
  return (
    <section className="space-y-6">
      ...
      <Modal title="编辑用户" open={!!editingUser} onCancel={closeEdit} onOk={() => form.submit()} confirmLoading={saving} okText="保存" cancelText="取消" destroyOnHidden>
