...
export default function ArticleEditor({ value = "", onChange }: ArticleEditorProps) {
  ...
  return (
    <div className="article-editor overflow-hidden rounded-none border border-hairline bg-surface">
      {/* 顶部工具栏：所有格式命令均来自 @tiptap/starter-kit（加粗/斜体/标题/列表/引用/代码块/分隔线/撤销重做） */}
      <div role="toolbar" aria-label="富文本格式工具栏" className="flex flex-wrap items-center gap-1 border-b border-hairline bg-surface-soft px-2 py-1">
